...
const Sidebar3 = () => {
  ...
  return (
    <div className="bgwhite h-100 overflow-auto relative sidebar3">
      <div className="">
                      ...
                      <div class="accordion my2">
                        <div class="tab">
                          ...
                          <div class="tab__content">
                            <div className="grid grid-cols-1 prpx19 plpx14">
                              {e.dropdown.map((drop) => (
                                <NavLink
                                  activeClassName="active"
                                  className="flex items-center activesidebar py7 px10 gap-9"
                                  to={drop.route}
                                >
                                  <FeatherIcon
                                    icon={drop.icon}
